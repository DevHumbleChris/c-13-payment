export default function Notification () {
    return (
        <div className="w-full h-60 overflow-x-hidden transform translate-x-0 transition ease-in-out duration-700" id="notification">
            <div className="overflow-y-auto p-2">
                ...
                <div className="w-full p-3 mt-2 bg-white rounded shadow flex flex-shrink-0">
                ...
                <div className="w-full p-3 mt-2 bg-red-100 rounded flex items-center">
